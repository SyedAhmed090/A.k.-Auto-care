      ...
      <div className="max-w-md w-full text-center">
        ...
        >
          <div className="flex items-center gap-3 mb-5">
            <Package className="w-4.5 h-4.5" style={{ color: "var(--accent)" }} />
            <h2 className="uppercase" style={{ fontFamily: "var(--font-anton)", fontSize: "1.2rem" }}>Order Details</h2>
          </div>
          <div className="space-y-3 text-sm" style={{ borderTop: "1px solid var(--line)" }}>
            {[
              ...
              <div key={row.label} className="flex justify-between py-3" style={{ borderBottom: "1px solid var(--line)" }}>
        ...
        >
          Continue Shopping <ArrowRight className="w-4.5 h-4.5" />
        </Link>
