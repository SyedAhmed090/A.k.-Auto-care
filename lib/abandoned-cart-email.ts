            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
                ...
                <td valign="middle">
                  ...
                  <div style="color:#e8a020;font-size:13px;margin-top:4px;">Rs ${(item.price * item.quantity).toLocaleString("en-PK")} &nbsp;<span style="color:#666;font-weight:400;">× ${item.quantity}</span></div>
                </td>
              </tr>
            </table>
          </td>
...
<body style="margin:0;padding:0;background:#0c0b08;font-family:Arial,Helvetica,sans-serif;">
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#0c0b08;">
    <tr>
      <td align="center" style="padding:32px 16px;">
        <table cellpadding="0" cellspacing="0" border="0" width="560" style="max-width:560px;width:100%;">

          <tr>
            <td style="background:#0c0b08;padding:24px 32px 0 32px;border-radius:12px 12px 0 0;">
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td>
                ...
                <tr>
                  <td style="padding-top:16px;">
                    <div style="height:2px;background:#e8a020;border-radius:1px;"></div>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="background:#111111;padding:32px 32px 24px 32px;">
              ...
              <table cellpadding="0" cellspacing="0" border="0" width="100%"
                style="background:#0c0b08;border-radius:8px;padding:0;margin-bottom:24px;">
                <tr>
              ...
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td align="center">
                    <a href="${recoveryUrl}"
                      style="display:inline-block;background:#e8a020;color:#000000;font-size:15px;font-weight:700;
          ...
          <tr>
            <td style="background:#0c0b08;padding:20px 32px;border-top:1px solid #1e1e1e;border-radius:0 0 12px 12px;">
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td style="color:#555555;font-size:11px;line-height:1.6;">
                    ...
                    <div style="margin-top:4px;">
                      ...
                      <a href="https://akautocare.pk" style="color:#e8a020;text-decoration:none;">akautocare.pk</a>.
